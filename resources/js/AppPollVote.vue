...
async function submitVote() {
    ...
    try {
        ...
        if (
        ...
        } else if (apiMessage.toLowerCase().includes('closed') || apiMessage.toLowerCase().includes('terminé')) {
            ...
            message.value = apiMessage || 'Erreur lors du vote. Veuillez réessayer.'
        }
        messageType.value = 'error'
    }
...
<template>
    ...
    <div class="max-w-xl mx-auto mt-8 px-4">
        ...
        <div v-else-if="poll" class="bg-white rounded-lg shadow p-6">
            ...
            <!-- Sondage terminé -->
            <div v-if="isExpired" class="bg-red-50 border border-red-200 text-red-700 rounded p-4 mb-4">
            ...
            <div v-else class="space-y-3">
                ...
                <div v-for="option in poll.options" :key="option.id" @click="toggleOption(option.id)"
                    ...
                    :class="selectedOptions.includes(option.id) ? 'border-blue-500 bg-blue-50' : 'border-gray-200'">
                ...
                <div class="mt-6 flex gap-3">
                    ...
                    <!-- Résultats -->
                    <a v-if="!poll.is_draft" :href="`/polls/${token}/results`"
            ...
            <!-- Message feedback -->
            <div v-if="message" class="mt-4 p-3 rounded text-sm"
